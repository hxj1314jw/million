package com.million.generator.utils;

import com.million.generator.entity.ColumnEntity;
import com.million.generator.entity.TableEntity;
...
public class GeneratorUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            columnEntity.setAttr_name(column.get("column_name"));
            //列名转换成Java属性名
