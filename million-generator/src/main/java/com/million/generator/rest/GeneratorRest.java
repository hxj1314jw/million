package com.million.generator.rest;

import com.alibaba.fastjson.JSON;
import com.million.generator.entity.TableResultResponse;
import com.million.generator.service.GeneratorService;
...
public class GeneratorRest {
    ...
    public void code(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"fucking-code.zip\"");
